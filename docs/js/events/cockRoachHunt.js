...
const SCENARIO_1_FAIL = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c1-fail-outcome`]: dialogueScreen({
      ...
      outcome: 'fail',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-arrival.jpg',
...
const SCENARIO_2_SUCCESS = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c2-success-outcome`]: dialogueScreen({
      ...
      outcome: 'success',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-barricade-success.jpg',
    ...
    [`${EVENT_ID}-c2-success-d1`]: dialogueScreen({
      ...
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-barricade-success-charge.jpg',
...
const SCENARIO_2_MIDDLE = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c2-middle-outcome`]: dialogueScreen({
      ...
      outcome: 'middle',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-barricade.jpg',
    ...
    [`${EVENT_ID}-c2-middle-d1`]: dialogueScreen({
      ...
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-charge-barricade.jpg',
...
const SCENARIO_2_FAIL = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c2-fail-outcome`]: dialogueScreen({
      ...
      outcome: 'fail',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-barricade-fail.jpg',
...
const SCENARIO_3_SUCCESS = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c3-success-outcome`]: dialogueScreen({
      ...
      outcome: 'success',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-pheromones.jpg',
    ...
    [`${EVENT_ID}-c3-success-choice`]: choiceScreen({
      ...
      choices: [
        Object.freeze({
          ...
          next: `${EVENT_ID}-c3-success-fight-action`,
          startsCombat: true
        }),
        Object.freeze({
          id: `${EVENT_ID}-c3-success-leave`,
          text: 'Quitter le niveau.',
          next: `${EVENT_ID}-c3-success-leave-action`
        })
      ]
    }),
    [`${EVENT_ID}-c3-success-fight-action`]: actionScreen({
      id: `${EVENT_ID}-c3-success-fight-action`,
      actions: ['forceBattle']
    }),
    [`${EVENT_ID}-c3-success-leave-action`]: actionScreen({
      id: `${EVENT_ID}-c3-success-leave-action`,
      actions: ['quitLevel'],
      endEvent: 'finished'
    })
  })
...
const SCENARIO_3_MIDDLE = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c3-middle-outcome`]: dialogueScreen({
      ...
      outcome: 'middle',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-blood-bait.jpg',
...
const SCENARIO_3_FAIL = Object.freeze({
  ...
  nodes: Object.freeze({
    [`${EVENT_ID}-c3-fail-outcome`]: dialogueScreen({
      ...
      outcome: 'fail',
      cinematic: 'hard',
      img: './media/lore/events/cockroachking-order.jpg',
